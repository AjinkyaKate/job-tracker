...
| 04 | `04_python_basics.md` — variables, types, lists, dicts, functions, control flow | Ship 1 |
| 05 | `05_what_is_a_database.md` — tables, rows, SQL, SQLite | Ship 2 |
| 06 | `06_what_is_an_api.md` — HTTP, requests, JSON, status codes | Ship 3 prep |
| 07 | `07_what_is_an_llm_api.md` — prompts, tokens, structured output, Anthropic SDK | Ship 5 |
| 08 | `08_what_is_a_backend.md` — server, request/response cycle, FastAPI | Ship 11 |
| 09 | `09_what_is_a_frontend.md` — HTML, browser, HTMX, why not React (yet) | Ship 12 |
| 10 | `10_what_is_deployment.md` — hosting, environments, secrets, env vars | Ship 15 |
| 11 | `11_writing_good_code.md` — naming, function size, comments, structure | cross-cutting |
| 12 | `12_how_systems_connect.md` — end-to-end flow of a single user request | after Ship 11 |
